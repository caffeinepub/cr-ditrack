...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    getPaiementsParStore: IDL.Func([IDL.Text], [IDL.Vec(Paiement)], ['query']),
    ...
    addStoreNotif: IDL.Func([StoreNotif], [], []),
    getStoreNotifs: IDL.Func([IDL.Text], [IDL.Vec(StoreNotif)], ['query']),
    markStoreNotifsRead: IDL.Func([IDL.Text], [], []),
    addAdminNotif: IDL.Func([AdminNotif], [], []),
    getAdminNotifs: IDL.Func([], [IDL.Vec(AdminNotif)], ['query']),
    markAdminNotifsRead: IDL.Func([], [], []),
